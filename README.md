...
# cordova-plugin-media-mp4


This plugin provides the ability to record and play back audio files on a device, adding support for the mp4 file type on both Android and iOS.
